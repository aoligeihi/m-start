...
public class ConsumerHeaders {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
         ...
         */
        channel.queueBind("yang_demo_queue_headers_1", "yang_demo_exchange_headers", "", headersMap);
         ...
         * 4.取消消息的回回调函数.
         */
        channel.basicConsume("yang_demo_queue_headers_1", true, deliverCallback, cancelCallback);
    }
}
